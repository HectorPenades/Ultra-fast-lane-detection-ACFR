...
def merge_config():
    ...
    if cfg.dataset == 'CULane':
        # Use full-image row anchors by default (0.0 -> 1.0) so evaluation
        # covers the whole vertical extent of the image. The original code
        # started at 0.42 to ignore sky/crop; for your dataset we want full
        # lines (no top crop).
